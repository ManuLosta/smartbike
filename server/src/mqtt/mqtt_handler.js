...
import { appendLocation, appendSpeed, createSession, endSession } from '../service/mqttService.js'
        ...
        this.mqttClient.on("message", (topic, message) => {
            ...
            switch (topic) {
                ...
                case "smartbike/inel00/session/stop":
                    endSession()
                    return
                case "smartbike/inel00/01/data/speed":
                    appendSpeed(message)
                    return
                case "smartbike/inel00/01/data/location":
                    appendLocation(message)
                    return
            }
        })
